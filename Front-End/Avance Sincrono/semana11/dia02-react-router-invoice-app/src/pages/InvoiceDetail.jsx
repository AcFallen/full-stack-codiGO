...
const InvoiceDetail = () => {
    ...
    return(
        <main className="w-[740px] m-auto flex flex-col gap-5">
            ...
            <header className="flex justify-between items-center bg-slate-700 py-4 px-8 mt-10 rounded-lg"> 
                ...
                <div className="flex items-center gap-3">
                    {/* TODO: Crear un componente llamado BaseButton que puede utilizar  mas abajo */}
                    <BaseButton label='Edit' bgColor='bg-slate-800' />
                    <BaseButton label='Delete' bgColor='bg-red-500' />
                    <BaseButton label='Mark as Paid' bgColor='bg-violet-500' />
                </div>
            </header>
